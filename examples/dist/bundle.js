	...
	render: function render() {
		...
		if (!this.props.useTether) {
			...
			_return = _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'button',
					{ className: 'Select-ControlOverlay', onClick: function () {
							_this9.setState({ isOpen: !isOpen });
						} },
...
},{"./Async":4,"./AsyncCreatable":5,"./Creatable":6,"./MultiSelectValueList":7,"./Option":8,"./Value":9,"./utils/defaultArrowRenderer":10,"./utils/defaultClearRenderer":11,"./utils/defaultFilterOptions":12,"./utils/defaultMenuRenderer":13,"classnames":undefined,"react":undefined,"react-dom":undefined,"react-input-autosize":undefined,"react-tether":2}]},{},[]);
