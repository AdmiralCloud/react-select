...
var Select = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    multiSelectListBelow: _react2['default'].PropTypes.bool, // render list of selected items below the select
  ...
  filterOptions: function filterOptions(excludeOptions) {
    ...
    if (typeof this.props.filterOptions === 'function') {
      ...
      return options.filter(function (option) {
        if (excludeOptions && excludeOptions.indexOf(option[_this4.props.valueKey]) > -1) {
          return false;
        }
        if (_this4.props.filterOption) {
          return _this4.props.filterOption.call(_this4, option, filterValue);
        }
        if (!filterValue) {
          return true;
        }
        ...
        if (_this4.props.ignoreAccents) {
          if (_this4.props.matchProp !== 'label') {
            valueTest = (0, _utilsStripDiacritics2['default'])(valueTest);
          }
          if (_this4.props.matchProp !== 'value') {
...
},{"./Async":1,"./MultiSelectValueList":2,"./Option":3,"./Value":5,"./utils/stripDiacritics":6}],5:[function(require,module,exports){
(function (global){
'use strict';
