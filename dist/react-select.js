(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('classnames'), require('prop-types'), require('react'), require('react-dom'), require('react-input-autosize')) :
	typeof define === 'function' && define.amd ? define(['classnames', 'prop-types', 'react', 'react-dom', 'react-input-autosize'], factory) :
	(global.Select = factory(global.classNames,global.PropTypes,global.React,global.ReactDOM,global.AutosizeInput));
}(this, (function (classNames,PropTypes,React,reactDom,AutosizeInput) { 'use strict';
...
var MultiSelectValueList = function (_React$Component) {
  inherits(MultiSelectValueList, _React$Component);

  function MultiSelectValueList(props) {
    classCallCheck(this, MultiSelectValueList);

    var _this = possibleConstructorReturn(this, (MultiSelectValueList.__proto__ || Object.getPrototypeOf(MultiSelectValueList)).call(this, props));
  ...
  createClass(MultiSelectValueList, [{
    key: 'handleMouseDown',
...
var Select$1 = function (_React$Component) {
    ...
    createClass(Select, [{
        ...
        key: 'renderMultiSelectedList',
        value: function renderMultiSelectedList(valueArray) {
            var _this6 = this;
        ...
        value: function renderInput(valueArray, focusedOptionIndex) {
            ...
            // const placeholder = typeof this.props.placeholder === 'string' ? this.props.placeholder : '';
            ...
            var inputProps = _extends({}, this.props.inputProps, {
                ...
                value: value
                // placeholder: placeholder, // AC change
            });
        ...
        value: function render() {
            ...
            // AC change
            var multiSelectListStyle = classNames({
            ...
            return React__default.createElement(
                ...
                // AC change
                this.props.multiSelectListBelow && valueArray.length > 0 ? React__default.createElement(
                    'div',
