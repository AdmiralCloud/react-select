(function (global, factory) {
	...
	(global = global || self, global.Select = factory(global.React, global.PropTypes, global.ReactDOM, global.AutosizeInput, global.classNames));
	...
	var Select = function (_React$Component) {
	    ...
	    createClass(Select, [{
	        ...
	        value: function renderInput(valueArray, focusedOptionIndex) {
	            ...
	            var placeholder = typeof this.props.placeholder === 'string' ? this.props.placeholder : '';
	        ...
	        value: function renderClear() {
	            if (!this.props.clearable || this.props.value === undefined || this.props.value === null || this.props.multi && !this.props.value.length || this.props.disabled || this.props.isLoading) {
	                return;
	            }
					...
					function (asyncProps) {
						return React__default.createElement(
							...
							function (creatableProps) {
								return React__default.createElement(Select, _extends({}, reduce(asyncProps, reduce(creatableProps, {})), {
