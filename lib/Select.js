...
Select.propTypes = {
    ...
    multiSelectListBelow: _propTypes2.default.bool, // render list of selected items below the selectthis field name for html forms
    newOptionCreator: _propTypes2.default.func, // factory to create new options when allowCreate set
    showSelectedCount: _propTypes2.default.bool, // show selected item count instead of default
    useTether: _propTypes2.default.bool // use react-tether for dropdowns
};
